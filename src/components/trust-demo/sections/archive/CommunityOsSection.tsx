...
import { SectionHeading, BlueLink, OC_BLUE } from '@/components/trust-demo/sectionKit';
import { LINKS } from '@/components/trust-demo/trustDemoData';

/**
 * ARCHIVED — not rendered anywhere.
 *
 * The "Community OS" section was dropped from the Trust Layer demo page
 * (it sat between Journey 4 and "For Developers"). Kept here so it can be
 * reused: import { KnowSection } and drop it back into TrustLayerDemoPage.
 */
