...
import { ArrowBack, Lock, Send, ExitToApp, Close, DoneAll } from '@mui/icons-material';
...
const IncomingBubble = ({ initial, name, message, time }: IncomingBubbleProps) => (
...
const OutgoingBubble = ({ message, time }: OutgoingBubbleProps) => (
...
export const IntroGroupChatScreen = () => {
  return (
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column', bgcolor: 'background.default' }}>
      ...
      {/* Subtle bow-out option */}
      <Box sx={{ px: 2, py: 0.75, borderTop: '1px solid', borderColor: 'divider', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 3 }}>
        <Button
          size="small"
