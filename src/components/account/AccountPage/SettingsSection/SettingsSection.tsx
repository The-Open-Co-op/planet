...
export const SettingsSection = forwardRef<HTMLDivElement, SettingsSectionProps>(
  ({ rCards, selectedRCard, onRCardSelect, onCreateRCard, onEditRCard, onUpdate, initialProfileData }, ref) => {
          ...
          <Grid size={{ xs: 12, md: 8 }}>
            {selectedRCard ? (
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                ...
                {/* Vouches for this rCard */}
                <VouchesSection cardName={selectedRCard.name} />
              </Box>
            ) : (
              <Card>
                <CardContent sx={{ textAlign: 'center', py: 8 }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Choose a profile card from the list to view and edit its settings
                  </Typography>
                </CardContent>
              </Card>
            )}
