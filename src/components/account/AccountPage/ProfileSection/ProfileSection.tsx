...
import type {CustomSocialLink, ProfileData, ProfileSectionProps} from '../types';
...
export const ProfileSection = forwardRef<HTMLDivElement, ProfileSectionProps>(
  ({ personhoodCredentials, initialProfileData }, ref) => {
    ...
    const [profileData, setProfileData] = useState<ProfileData>(initialProfileData ?? mockProfileData);
